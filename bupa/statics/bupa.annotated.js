...
angular.module('bupa.core.useful-documents').controller('UsefulDocumentsCtrl', ["APP_CONFIG", "SFDC", "$scope", function (APP_CONFIG, SFDC, $scope) {
  'use strict';
...
angular.module('bupa.core.useful-links').controller('UsefulLinksCtrl', ["APP_CONFIG", "SFDC", "$scope", "$q", function (APP_CONFIG, SFDC, $scope, $q) {
  'use strict';
...
]).config(["$stateProvider", "APP_CONFIG", "$tooltipProvider", function ($stateProvider, APP_CONFIG, $tooltipProvider) {
  'use strict';
...
angular.module('bupa.core.procedures').service('bpProcedures', ["ngLazy", "$log", "SFDC", function (ngLazy, $log, SFDC) {
  'use strict';
...
angular.module('bupa.core.procedures').controller('BpProceduresCtrl', ["APP_CONFIG", "Lazy", "$scope", "SFDC", "ngTableParams", "$log", "$location", "$filter", "$window", "$q", "$timeout", "bpSharedCode", "$sce", "bpProcedures", function(APP_CONFIG, Lazy, $scope, SFDC, ngTableParams, $log, $location, $filter, $window, $q, $timeout, bpSharedCode, $sce, bpProcedures) {
  'use strict';
...
angular.module('bupa.core.essential-notes').service('bpEssentialNotes', ["ngLazy", "$log", "SFDC", function (ngLazy, $log, SFDC) {
  'use strict';
...
angular.module('bupa.core.essential-notes').controller('EssentialNotesCtrl', ["SFDC", "$scope", "$q", "$log", "bpEssentialNotes", function (SFDC, $scope, $q, $log, bpEssentialNotes) {
  'use strict';
...
angular.module('bupa.core.home').controller('BpHomeCtrl', ["APP_CONFIG", "$scope", function (APP_CONFIG, $scope) {
  'use strict';
...
]).config(["$stateProvider", "APP_CONFIG", function ($stateProvider, APP_CONFIG) {
  'use strict';
...
angular.module('bupa.core.drugs').service('bpDrugs', ["$window", function ($window) {
  'use strict';
...
angular.module('bupa.core.drugs').controller('BpDrugsCtrl', ["APP_CONFIG", "$scope", "bpDrugs", "$log", "ngTableParams", "$filter", "$q", "$window", "$location", "$sce", "$timeout", "SFDC", function (APP_CONFIG, $scope, bpDrugs, $log, ngTableParams, $filter, $q, $window, $location, $sce, $timeout, SFDC) {
  'use strict';
  /*jshint camelcase: false */
...
angular.module('bupa.core.diagnostics').service('bpDiagnostics', ["$window", function ($window) {
  'use strict';
...
angular.module('bupa.core.diagnostics').controller('BpDiagnosticsCtrl', ["APP_CONFIG", "$scope", "bpDiagnostics", "$log", "ngTableParams", "$filter", "$q", "$window", "$location", "$sce", "$timeout", "SFDC", function (APP_CONFIG, $scope, bpDiagnostics, $log, ngTableParams, $filter, $q, $window, $location, $sce, $timeout, SFDC) {
  'use strict';
  /*jshint camelcase: false */
...
angular.module('bupa.core.contact-us').service('bpContactUs', ["APP_CONFIG", "$q", "$log", "$window", function (APP_CONFIG, $q, $log, $window) {
  'use strict';
...
angular.module('bupa.core.contact-us').controller('ContactUsCtrl', ["APP_CONFIG", "SFDC", "$scope", "$log", "bpContactUs", function (APP_CONFIG, SFDC, $scope, $log, bpContactUs) {
  'use strict';
...
angular.module('bupa.core.benefit-maxima').service('bpBenefitMaxima', ["SFDC", function (SFDC) {
  'use strict';
...
angular.module('bupa.core.benefit-maxima').controller('BenefitMaximaCtrl', ["$q", "$scope", "bpBenefitMaxima", function ($q, $scope, bpBenefitMaxima) {
  'use strict';
...
angular.module('bupa.core.appendices').service('bpAppendices', ["ngLazy", "SFDC", function (ngLazy, SFDC) {
  'use strict';
...
angular.module('bupa.core.appendices').controller('AppendicesCtrl', ["$q", "$scope", "bpAppendices", function ($q, $scope, bpAppendices) {
  'use strict';
...
]).config(["$translateProvider", "BP_VISUAL_FORCE_CUSTOM_LABELS", function ($translateProvider, BP_VISUAL_FORCE_CUSTOM_LABELS) {
  'use strict';
...
angular.module('bupa.common.footer').controller('BpFooterCtrl', ["APP_CONFIG", "$scope", function (APP_CONFIG, $scope) {
  'use strict';
...
angular.module('bupa.common.navbar').controller('NavBarCtrl', ["APP_CONFIG", "$scope", "$state", function (APP_CONFIG, $scope, $state) {
  'use strict';
...
/*jshint camelcase: false */
angular.module('bupa.core').factory('bpSharedCode', ["$location", "$log", "$sce", "$window", function ($location, $log, $sce, $window) {
  'use strict';
...
angular.module('bupa.core').factory('SFDC', ["APP_CONFIG", "$q", "$http", "$log", "$window", "$timeout", "$cacheFactory", function(APP_CONFIG, $q, $http, $log, $window, $timeout, $cacheFactory) {
  'use strict';
...
}]).run(["SFDC", "APP_CONFIG", "$window", function(SFDC, APP_CONFIG, $window) {
  'use strict';
...
angular.module('config', []).constant('APP_CONFIG', angular.extend({
  ...
  .config(["APP_CONFIG", "$logProvider", "$compileProvider", function (APP_CONFIG, $logProvider, $compileProvider) {
    'use strict';
  ...
  .run(["APP_CONFIG", "$log", function (APP_CONFIG, $log) {
    'use strict';
...
angular.module('bupa.common').filter('bpSceTrustAsHtml', ["$sce", function ($sce) {
  'use strict';
  return $sce.trustAsHtml;
}]);

angular.module('bupa.common').directive('dynamic', ["$compile", function ($compile) {
  'use strict';
...
angular.module('bupa.common.browserversion', []).service('bpBrowserVersion', ["$window", function ($window) {
  'use strict';
...
}]).run(["$log", "APP_CONFIG", function ($log, APP_CONFIG) {
  'use strict';
